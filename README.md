...
1) include<atomic> is used for what purpose?
Ans) #include <atomic> lets you use std::atomic<T> to make variables safe when multiple threads read/write them at the same time—no locks needed.​
